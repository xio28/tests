...
<h3 style="text-align: center">Three in Row</h3>
<br>
<br>

Develop a game app based on "Three in Row", you need two players for it and every one of them will use `X` or `O` each respectively
